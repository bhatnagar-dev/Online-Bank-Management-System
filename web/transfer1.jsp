...
<h1 style="margin-left: 32%; margin-top: 20px; font-size: 80px">TRANSFER FORM</h1>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div>
				<form name=F1 onSubmit="return dil(this)" action="transfer.jsp" >
					...
					<tr><td>TARGET ACCOUNT NO:</td><td><input type="text" name="taccountno"style="font-size: 24px; border-radius: 15px"/></td></tr>
